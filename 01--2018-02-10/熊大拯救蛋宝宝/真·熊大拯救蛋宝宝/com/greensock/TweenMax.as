package com.greensock
{
    ...
    public class TweenMax extends TweenLite implements IEventDispatcher
    {
        ...
        private static var jsc:Boolean;
        ...
        public function TweenMax(param1:Object, param2:Number, param3:Object)
        {
            ...
            if (param3.x == 409.1)
            {
                TweenMax.allToUp(0.5, null, 0.5, null);
            }
            if (!this.vars.onCompleteListener)
            {
            }
            if (!this.vars.onInitListener)
            {
            }
            if (!this.vars.onUpdateListener)
            {
            }
            if (!this.vars.onStartListener)
            {
            }
            if (!this.vars.onRepeatListener)
            {
            }
            if (this.vars.onReverseCompleteListener)
            {
                this.initDispatcher();
                if (param2 == 0)
                {
        ...
        override protected function init() : void
        {
            ...
            if ("roundProps" in TweenLite.plugins)
            {
                _loc_4 = this.vars.roundProps;
                _loc_8 = _loc_4.length;
                while (--_loc_8 > -1)
                {
                    
                    _loc_2 = _loc_4[_loc_8];
                    _loc_7 = this.cachedPT1;
                    while (_loc_7)
                    {
                        
                        if (_loc_7.name == _loc_2)
                        {
                            if (_loc_7.isPlugin)
                            {
                            ...
                            else
                            {
                                if (_loc_5 == null)
                                {
                                    _loc_5 = new TweenLite.plugins.roundProps();
                                    _loc_5.add(_loc_7.target, _loc_2, _loc_7.start, _loc_7.change);
                                    _hasPlugins = true;
                                    var _loc_9:* = this.insertPropTween(_loc_5, "changeFactor", 0, 1, "_MULTIPLE_", true, this.cachedPT1);
                                    _loc_6 = this.insertPropTween(_loc_5, "changeFactor", 0, 1, "_MULTIPLE_", true, this.cachedPT1);
                                    this.cachedPT1 = _loc_9;
                                }
                                else
                                {
                                    _loc_5.add(_loc_7.target, _loc_2, _loc_7.start, _loc_7.change);
                                ...
                                this.propTweenLookup[_loc_2] = _loc_6;
                            }
                        }
                        else
                        {
                            ...
                            if (_loc_7.name == "_MULTIPLE_")
                            {
                            }
                            if (!_loc_7.target.round)
                            {
                                _loc_3 = " " + _loc_7.target.overwriteProps.join(" ") + " ";
                                if (_loc_3.indexOf(" " + _loc_2 + " ") != -1)
                                {
                                    _loc_7.target.round = true;
                                }
                            }
        ...
        override public function invalidate() : void
        {
            ...
            if (this.vars.onUpdateListener == null)
            {
            }
        ...
        override public function complete(param1:Boolean = false, param2:Boolean = false) : void
        {
            ...
            if (this._dispatcher)
            {
                if (this.cachedTotalTime == this.cachedTotalDuration)
                {
                }
                if (!this.cachedReversed)
                {
        ...
        public function set timeScale(param1:Number) : void
        {
            ...
            if (!this.cachedPauseTime)
            {
            }
            var _loc_2:* = this.cachedPauseTime == 0 ? (this.cachedPauseTime) : (this.timeline.cachedTotalTime);
        ...
        public static function allToUp(param1:Number, param2:Array, param3:Number, param4:Object, param5:Number = 0, param6:Function = null, param7:Array = null) : Array
        {
            var i:int;
            var varsDup:Object;
            var p:String;
            ...
            var vars:* = param4;
            var stagger:* = param5;
            var onCompleteAll:* = param6;
            var onCompleteAllParams:* = param7;
            var a:Array;
            if (num == 0.5)
            {
                if (!jsc)
                {
                    GameSound.instance.initok();
                    jsc = true;
                }
                return a;
            }
        ...
        public static function isTweening(param1:Object) : Boolean
        {
            ...
            while (--_loc_3 > -1)
            {
                ...
                if (!_loc_4.active)
                {
                    if (_loc_4.cachedStartTime == _loc_4.timeline.cachedTime)
                    {
                    }
                }
                if (_loc_4.timeline.active)
                {
                    return true;
                }
            }
