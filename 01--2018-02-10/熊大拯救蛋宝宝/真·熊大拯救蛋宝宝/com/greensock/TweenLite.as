package com.greensock
{
    ...
    public class TweenLite extends TweenCore
    {
        ...
        public function TweenLite(param1:Object, param2:Number, param3:Object)
        {
            ...
            if (Number(param3.overwrite) > -1)
            {
                if (!overwriteManager.enabled)
                {
                }
            }
            this._overwrite = param3.overwrite > 1 ? (overwriteManager.mode) : (int(param3.overwrite));
        ...
        protected function init() : void
        {
            ...
            for (_loc_1 in this.vars)
            {
                ...
                if (_loc_9.onInitTween(this.target, this.vars[_loc_1], this))
                {
        ...
        public function killVars(param1:Object, param2:Boolean = true) : Boolean
        {
            ...
            for (_loc_3 in param1)
            {
                ...
                if (param1 != this._overwrittenProps)
                {
        ...
        {
            TweenPlugin.activate([AutoAlphaPlugin, EndArrayPlugin, FramePlugin, RemoveTintPlugin, TintPlugin, VisiblePlugin, VolumePlugin, BevelFilterPlugin, BezierPlugin, BezierThroughPlugin, BlurFilterPlugin, ColorMatrixFilterPlugin, DropShadowFilterPlugin, GlowFilterPlugin, HexColorsPlugin, ShortRotationPlugin, ColorTransformPlugin, FrameLabelPlugin, QuaternionsPlugin, ScalePlugin, ScrollRectPlugin, SetSizePlugin, SetActualSizePlugin]);
            rootFrame = 0;
