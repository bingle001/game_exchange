package com.greensock.core
{
    ...
    public class TweenCore extends Object
    {
        ...
        public function TweenCore(param1:Number = 0, param2:Object = null)
        {
            ...
            this.active = Boolean(this.vars.immediateRender != false);
            var _loc_4:* = 0;
            this.cachedTime = 0;
        ...
        public function setEnabled(param1:Boolean, param2:Boolean = false) : Boolean
        {
            ...
            if (param1)
            {
                ...
                this.active = Boolean(this.cachedTotalTime < this.cachedTotalDuration);
                if (!param2)
                {
                }
                if (this.cachedOrphan)
                {
        ...
        protected function setTotalTime(param1:Number, param2:Boolean = false) : void
        {
            ...
            if (this.timeline)
            {
                ...
                _loc_3 = this.cachedPauseTime == 0 ? (this.cachedPauseTime) : (this.timeline.cachedTotalTime);
                if (this.cachedReversed)
                {
        ...
        public function set startTime(param1:Number) : void
        {
            ...
            {
                if (param1 == this.cachedStartTime)
                {
                }
            }
            var _loc_2:* = Boolean(this.gc);
