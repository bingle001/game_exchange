package com.greensock.plugins
{
    ...
    public class FilterPlugin extends TweenPlugin
    {
        ...
        protected function initFilter(param1:Object, param2:BitmapFilter, param3:Array) : void
        {
            ...
            if (_loc_4[this._index] != null)
            {
            }
            if (_loc_8.addFilter == true)
            {
            ...
            while (_loc_6--)
            {
                ...
                if (this._filter[_loc_5] != param1[_loc_5])
                {
                    if (_loc_5 != "color")
                    {
                    }
                    if (_loc_5 != "highlightColor")
                    {
                    }
                    if (_loc_5 == "shadowColor")
                    {
